...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EgressGroupPatch)(nil), (*controlplane.EgressGroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_EgressGroup_To_controlplane_EgressGroup(a.(*EgressGroupPatch), b.(*controlplane.EgressGroupPatch), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressGroupPatch)(nil), (*EgressGroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressGroup_To_v1beta2_EgressGroup(a.(*controlplane.EgressGroupPatch), b.(*EgressGroupPatch), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EgressPolicy)(nil), (*controlplane.EgressPolicy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_EgressPolicy_To_controlplane_EgressPolicy(a.(*EgressPolicy), b.(*controlplane.EgressPolicy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressPolicy)(nil), (*EgressPolicy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressPolicy_To_v1beta2_EgressPolicy(a.(*controlplane.EgressPolicy), b.(*EgressPolicy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EgressPolicyList)(nil), (*controlplane.EgressPolicyList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_EgressPolicyList_To_controlplane_EgressPolicyList(a.(*EgressPolicyList), b.(*controlplane.EgressPolicyList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressPolicyList)(nil), (*EgressPolicyList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressPolicyList_To_v1beta2_EgressPolicyList(a.(*controlplane.EgressPolicyList), b.(*EgressPolicyList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_EgressGroup_To_controlplane_EgressGroup(in *EgressGroupPatch, out *controlplane.EgressGroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.GroupMembers = *(*[]controlplane.GroupMember)(unsafe.Pointer(&in.GroupMembers))
	return nil
}
...
func Convert_v1beta2_EgressGroup_To_controlplane_EgressGroup(in *EgressGroupPatch, out *controlplane.EgressGroupPatch, s conversion.Scope) error {
	return autoConvert_v1beta2_EgressGroup_To_controlplane_EgressGroup(in, out, s)
}

func autoConvert_controlplane_EgressGroup_To_v1beta2_EgressGroup(in *controlplane.EgressGroupPatch, out *EgressGroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.GroupMembers = *(*[]GroupMember)(unsafe.Pointer(&in.GroupMembers))
	return nil
}
...
func Convert_controlplane_EgressGroup_To_v1beta2_EgressGroup(in *controlplane.EgressGroupPatch, out *EgressGroupPatch, s conversion.Scope) error {
	return autoConvert_controlplane_EgressGroup_To_v1beta2_EgressGroup(in, out, s)
}

func autoConvert_v1beta2_EgressPolicy_To_controlplane_EgressPolicy(in *EgressPolicy, out *controlplane.EgressPolicy, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
// Convert_v1beta2_EgressPolicy_To_controlplane_EgressPolicy is an autogenerated conversion function.
func Convert_v1beta2_EgressPolicy_To_controlplane_EgressPolicy(in *EgressPolicy, out *controlplane.EgressPolicy, s conversion.Scope) error {
	return autoConvert_v1beta2_EgressPolicy_To_controlplane_EgressPolicy(in, out, s)
}

func autoConvert_controlplane_EgressPolicy_To_v1beta2_EgressPolicy(in *controlplane.EgressPolicy, out *EgressPolicy, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.EgressGroup = in.EgressGroup
	out.EgressIP = in.EgressIP
	return nil
...
// Convert_controlplane_EgressPolicy_To_v1beta2_EgressPolicy is an autogenerated conversion function.
func Convert_controlplane_EgressPolicy_To_v1beta2_EgressPolicy(in *controlplane.EgressPolicy, out *EgressPolicy, s conversion.Scope) error {
	return autoConvert_controlplane_EgressPolicy_To_v1beta2_EgressPolicy(in, out, s)
}

func autoConvert_v1beta2_EgressPolicyList_To_controlplane_EgressPolicyList(in *EgressPolicyList, out *controlplane.EgressPolicyList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]controlplane.EgressPolicy)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1beta2_EgressPolicyList_To_controlplane_EgressPolicyList is an autogenerated conversion function.
func Convert_v1beta2_EgressPolicyList_To_controlplane_EgressPolicyList(in *EgressPolicyList, out *controlplane.EgressPolicyList, s conversion.Scope) error {
	return autoConvert_v1beta2_EgressPolicyList_To_controlplane_EgressPolicyList(in, out, s)
}

func autoConvert_controlplane_EgressPolicyList_To_v1beta2_EgressPolicyList(in *controlplane.EgressPolicyList, out *EgressPolicyList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]EgressPolicy)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_controlplane_EgressPolicyList_To_v1beta2_EgressPolicyList is an autogenerated conversion function.
func Convert_controlplane_EgressPolicyList_To_v1beta2_EgressPolicyList(in *controlplane.EgressPolicyList, out *EgressPolicyList, s conversion.Scope) error {
	return autoConvert_controlplane_EgressPolicyList_To_v1beta2_EgressPolicyList(in, out, s)
}

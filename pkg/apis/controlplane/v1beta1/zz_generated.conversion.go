...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EgressGroup)(nil), (*controlplane.EgressGroup)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_EgressGroup_To_controlplane_EgressGroup(a.(*EgressGroup), b.(*controlplane.EgressGroup), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressGroup)(nil), (*EgressGroup)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressGroup_To_v1beta1_EgressGroup(a.(*controlplane.EgressGroup), b.(*EgressGroup), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EgressGroupList)(nil), (*controlplane.EgressGroupList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_EgressGroupList_To_controlplane_EgressGroupList(a.(*EgressGroupList), b.(*controlplane.EgressGroupList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressGroupList)(nil), (*EgressGroupList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressGroupList_To_v1beta1_EgressGroupList(a.(*controlplane.EgressGroupList), b.(*EgressGroupList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EgressPolicy)(nil), (*controlplane.EgressPolicy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_EgressPolicy_To_controlplane_EgressPolicy(a.(*EgressPolicy), b.(*controlplane.EgressPolicy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressPolicy)(nil), (*EgressPolicy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressPolicy_To_v1beta1_EgressPolicy(a.(*controlplane.EgressPolicy), b.(*EgressPolicy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EgressPolicyList)(nil), (*controlplane.EgressPolicyList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_EgressPolicyList_To_controlplane_EgressPolicyList(a.(*EgressPolicyList), b.(*controlplane.EgressPolicyList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressPolicyList)(nil), (*EgressPolicyList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressPolicyList_To_v1beta1_EgressPolicyList(a.(*controlplane.EgressPolicyList), b.(*EgressPolicyList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_EgressGroup_To_controlplane_EgressGroup(in *EgressGroup, out *controlplane.EgressGroup, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if in.AddedGroupMembers != nil {
		in, out := &in.AddedGroupMembers, &out.AddedGroupMembers
		*out = make([]controlplane.GroupMember, len(*in))
...
// Convert_v1beta1_EgressGroup_To_controlplane_EgressGroup is an autogenerated conversion function.
func Convert_v1beta1_EgressGroup_To_controlplane_EgressGroup(in *EgressGroup, out *controlplane.EgressGroup, s conversion.Scope) error {
	return autoConvert_v1beta1_EgressGroup_To_controlplane_EgressGroup(in, out, s)
}

func autoConvert_controlplane_EgressGroup_To_v1beta1_EgressGroup(in *controlplane.EgressGroup, out *EgressGroup, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if in.AddedGroupMembers != nil {
		in, out := &in.AddedGroupMembers, &out.AddedGroupMembers
		*out = make([]GroupMember, len(*in))
...
// Convert_controlplane_EgressGroup_To_v1beta1_EgressGroup is an autogenerated conversion function.
func Convert_controlplane_EgressGroup_To_v1beta1_EgressGroup(in *controlplane.EgressGroup, out *EgressGroup, s conversion.Scope) error {
	return autoConvert_controlplane_EgressGroup_To_v1beta1_EgressGroup(in, out, s)
}

func autoConvert_v1beta1_EgressGroupList_To_controlplane_EgressGroupList(in *EgressGroupList, out *controlplane.EgressGroupList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]controlplane.EgressGroup, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_EgressGroup_To_controlplane_EgressGroup(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_v1beta1_EgressGroupList_To_controlplane_EgressGroupList is an autogenerated conversion function.
func Convert_v1beta1_EgressGroupList_To_controlplane_EgressGroupList(in *EgressGroupList, out *controlplane.EgressGroupList, s conversion.Scope) error {
	return autoConvert_v1beta1_EgressGroupList_To_controlplane_EgressGroupList(in, out, s)
}

func autoConvert_controlplane_EgressGroupList_To_v1beta1_EgressGroupList(in *controlplane.EgressGroupList, out *EgressGroupList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]EgressGroup, len(*in))
		for i := range *in {
			if err := Convert_controlplane_EgressGroup_To_v1beta1_EgressGroup(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_controlplane_EgressGroupList_To_v1beta1_EgressGroupList is an autogenerated conversion function.
func Convert_controlplane_EgressGroupList_To_v1beta1_EgressGroupList(in *controlplane.EgressGroupList, out *EgressGroupList, s conversion.Scope) error {
	return autoConvert_controlplane_EgressGroupList_To_v1beta1_EgressGroupList(in, out, s)
}

func autoConvert_v1beta1_EgressPolicy_To_controlplane_EgressPolicy(in *EgressPolicy, out *controlplane.EgressPolicy, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
// Convert_v1beta1_EgressPolicy_To_controlplane_EgressPolicy is an autogenerated conversion function.
func Convert_v1beta1_EgressPolicy_To_controlplane_EgressPolicy(in *EgressPolicy, out *controlplane.EgressPolicy, s conversion.Scope) error {
	return autoConvert_v1beta1_EgressPolicy_To_controlplane_EgressPolicy(in, out, s)
}

func autoConvert_controlplane_EgressPolicy_To_v1beta1_EgressPolicy(in *controlplane.EgressPolicy, out *EgressPolicy, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.EgressGroup = in.EgressGroup
	out.EgressIP = in.EgressIP
	return nil
...
// Convert_controlplane_EgressPolicy_To_v1beta1_EgressPolicy is an autogenerated conversion function.
func Convert_controlplane_EgressPolicy_To_v1beta1_EgressPolicy(in *controlplane.EgressPolicy, out *EgressPolicy, s conversion.Scope) error {
	return autoConvert_controlplane_EgressPolicy_To_v1beta1_EgressPolicy(in, out, s)
}

func autoConvert_v1beta1_EgressPolicyList_To_controlplane_EgressPolicyList(in *EgressPolicyList, out *controlplane.EgressPolicyList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]controlplane.EgressPolicy)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1beta1_EgressPolicyList_To_controlplane_EgressPolicyList is an autogenerated conversion function.
func Convert_v1beta1_EgressPolicyList_To_controlplane_EgressPolicyList(in *EgressPolicyList, out *controlplane.EgressPolicyList, s conversion.Scope) error {
	return autoConvert_v1beta1_EgressPolicyList_To_controlplane_EgressPolicyList(in, out, s)
}

func autoConvert_controlplane_EgressPolicyList_To_v1beta1_EgressPolicyList(in *controlplane.EgressPolicyList, out *EgressPolicyList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]EgressPolicy)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_controlplane_EgressPolicyList_To_v1beta1_EgressPolicyList is an autogenerated conversion function.
func Convert_controlplane_EgressPolicyList_To_v1beta1_EgressPolicyList(in *controlplane.EgressPolicyList, out *EgressPolicyList, s conversion.Scope) error {
	return autoConvert_controlplane_EgressPolicyList_To_v1beta1_EgressPolicyList(in, out, s)
}

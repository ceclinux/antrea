...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EgressGroupPatch)(nil), (*controlplane.EgressGroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_EgressGroup_To_controlplane_EgressGroup(a.(*EgressGroupPatch), b.(*controlplane.EgressGroupPatch), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressGroupPatch)(nil), (*EgressGroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressGroup_To_v1beta1_EgressGroup(a.(*controlplane.EgressGroupPatch), b.(*EgressGroupPatch), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_EgressGroup_To_controlplane_EgressGroup(in *EgressGroupPatch, out *controlplane.EgressGroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if in.GroupMembers != nil {
		in, out := &in.GroupMembers, &out.GroupMembers
		*out = make([]controlplane.GroupMember, len(*in))
...
func Convert_v1beta1_EgressGroup_To_controlplane_EgressGroup(in *EgressGroupPatch, out *controlplane.EgressGroupPatch, s conversion.Scope) error {
	return autoConvert_v1beta1_EgressGroup_To_controlplane_EgressGroup(in, out, s)
}

func autoConvert_controlplane_EgressGroup_To_v1beta1_EgressGroup(in *controlplane.EgressGroupPatch, out *EgressGroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if in.GroupMembers != nil {
		in, out := &in.GroupMembers, &out.GroupMembers
		*out = make([]GroupMember, len(*in))
...
func Convert_controlplane_EgressGroup_To_v1beta1_EgressGroup(in *controlplane.EgressGroupPatch, out *EgressGroupPatch, s conversion.Scope) error {
